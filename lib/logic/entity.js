...
.defines(function() {
	...
	Entity.prototype.update = function(timePassed) {
		// handle stickiness
		if(this.isSticky) {
	 ...
	 *  Stickyness:
	 */
	Entity.prototype.makeSticky = function(datGui) {
		this.isSticky = true;
		this.stickies = [];
	...
	Entity.prototype.createStickyJoints = function() {
		var body = this.body;
	...
	Entity.prototype.attachStickyJoints = function() {
		/*
	...
	Entity.prototype.removeStickyJoints = function() {
