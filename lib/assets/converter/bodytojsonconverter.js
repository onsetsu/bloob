...
SpringBody.prototype.toJson = function() {
	...
	json.edgeSpringK = this.mEdgeSpringK;
	json.edgeSpringDamp = this.mEdgeSpringDamp;
	json.shapeSpringK = this.mShapeSpringK;
	json.shapeSpringDamp = this.mShapeSpringDamp;
	json.internalSprings = this.mSprings;
...
PressureBody.prototype.toJson = function() {
	...
	json.gasPressure = this.getGasPressure();
