...
Scarlet
	...
	.include(includePath + "assets/converter/bodytojsonconverter")
	.include(basicPath + "jsontobodyconverter")
	.include(includePath + "assets/converter/decompressmapjson")
	.include(basicPath + "jsontomapconverter")

	.include(includePath + "assets/converter/worldtojsonconverter")
	.include(includePath + "assets/converter/maptojsonconverter")
	// basic for builder
