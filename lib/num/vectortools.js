define(function(require) {
	var Vector2 = require("./vector2"),
		PI_OVER_ONE_EIGHTY = require("./constants").PI_OVER_ONE_EIGHTY,
		ONE_EIGHTY_OVER_PI = require("./constants").ONE_EIGHTY_OVER_PI;

    // TODO: move functionality to vector2
	var VectorTools = {
		...
		// TODO: move all three to appropriate place
