...
.defines(function(main, Game, Sound, Track, TitleScene) {
	var BloobGame = Game.subclass({
		...
		testAudio: function() {
			...
			var testSound = new Sound(env.audio, "data/audio/sounds/test/cursor_sounds/water-bubble-high.wav");
			audioFolder.add(testSound, "play").name('play test sound');

			var testTrack = new Track(env.audio, "data/audio/music/test/217741_vibe_timid_girl.mp3");
