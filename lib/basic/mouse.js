...
.defines(function(Input, InteractionHandler) {
	...
	Mouse.prototype.update = function() {
		this.leftTechnique.fireCallback(Mouse.LeftButton);
		this.rightTechnique.fireCallback(Mouse.RightButton);
	};
	...
	Mouse.prototype.initDatGui = function(datGui, interactionTechniques) {
		...
		for (var index in interactionTechniques) {
			if(!interactionTechniques.hasOwnProperty(index)) continue;
