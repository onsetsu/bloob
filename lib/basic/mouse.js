...
Bloob.Mouse.prototype.update = function(timePassed) {
	Bloob.Mouse.InteractionTechniques[this.leftTechnique].callback.call(this, timePassed, "leftclick");
	Bloob.Mouse.InteractionTechniques[this.rightTechnique].callback.call(this, timePassed, "rightclick");
...
Bloob.Mouse.prototype.initDatGui = function() {
	...
	mouseFolder.add(this, 'leftTechnique', interactionTechniques).listen().onChange(function(blub) { Scarlet.log("you choosed", blub); });
