...
Bloob.JsonToMapConverter.convertOneBluePrint = function(oneBluePrintAsJson, shapeJson) {
	...
	Bloob.JsonToMapConverter.readBodyParameters(bluePrint, oneBluePrintAsJson);
	Bloob.JsonToMapConverter.readInternalSprings(bluePrint, oneBluePrintAsJson);
...
Bloob.JsonToMapConverter.constructBluePrintForActualBuilding = function(oneBluePrintAsJson, shapeJson) {
