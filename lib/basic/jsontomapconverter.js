...
Bloob.JsonToMapConverter.prototype.convertBodies = function(map, mapJson) {
	// TODO: move this logic to decompress
	// decompress map json if needed
	var decompressedMapJson;
	if(Bloob.DecompressMapJson.isCompressed(mapJson))
		decompressedMapJson = Bloob.DecompressMapJson.decompressJson(mapJson);
	else
		decompressedMapJson = mapJson;
