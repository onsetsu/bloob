		...
		buildDragBodyInWorld: function(world, camera) {
			...
			.onPressed(function(timePassed) {
				...
				this.drag = Utils.bind(function drag(body) {
					var mousePositionInWorldCoordinates = camera.screenToWorldCoordinates(env.input.mouse);
				...
				var answer = world.getClosestPointMass(camera.screenToWorldCoordinates(env.input.mouse));
