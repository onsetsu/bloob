	...
	var MapBuilder = {
		...
		"setUpMainLayer": function(layer, world) {
			...
			var drawImageAtPosition = function(entity, renderer) {
				...
				var worldMiddlePoint = this.getBody().getDerivedPosition();
			...
			for (i = 0; i <= 2; i++) {
				for (j = 0; j <= 3; j++) {
					...
					fireflyEntity.addDrawCallback(drawImageAtPosition);
				}
			}
		...
		"setUpLiquidLayer": function(layer, world) {
			...
			layer.fluidSystem = new Jiquid.System(layer, world);
