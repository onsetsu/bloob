	...
	var MapBuilder = {
		...
		"setUpTestMap": function(layer, world) {
			...
			blockEntity.setTexture(new Texture("sample.png")
				.from([new Jello.Vector2(0, 500), new Jello.Vector2(0, 0), new Jello.Vector2(500, 0)]).to([0,4,8])
				.from([new Jello.Vector2(500, 0), new Jello.Vector2(500, 500), new Jello.Vector2(0, 500)]).to([8,12,0])
			);
