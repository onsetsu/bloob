define([
	...
	var MapBuilder = {
		...
		"buildGroundRectangle": function(world, upperLeft, lowerRight, rotate) {
			...
			var groundBody = Jello.BodyFactory.createBluePrint("SpringBody")
				.world(world)
				.shape(groundShape)
		...
		"setUpMainLayer": function(layer, world) {
			...
			var particleBluePrint = Jello.BodyFactory.createBluePrint("Body")
				.world(world)
			...
			// Body
			var pb = Jello.BodyFactory.createBluePrint("PressureBody")
				.world(world)
			...
			layer.setInteraction(function() {
				...
				if(env.input.pressed("rightclick")) {
					Jello.BodyFactory.createBluePrint("SpringBody")
						.world(this.world)
			...
			// Body
			blockEntity.setBody(Jello.BodyFactory.createBluePrint("PressureBody")
				.world(world)
			...
			// Body
			stateAnimationShowCase.setBody(Jello.BodyFactory.createBluePrint("PressureBody")
				.world(world)
			...
			// Body
			movingGround.setBody(Jello.BodyFactory.createBluePrint("PressureBody")
				.world(world)
				.shape(ShapeBuilder.Shapes.Cube)
				.pointMasses(0)
			...
			var loftBluePrint = Jello.BodyFactory.createBluePrint("Body")
				.world(world)
				.shape(groundShape)
				.pointMasses(Utils.Array.fill(0, groundShape.getVertices().length))
			...
			function fuzzyEllipseGround(world, translate, rotate, scale) {
				...
				return Jello.BodyFactory.createBluePrint("Body")
					.world(world)
					.shape(groundShape)
					.pointMasses(Utils.Array.fill(0, groundShape.getVertices().length))
					.translate(translate)
			...
			var mass = 1 ;
			var groundBody = Jello.BodyFactory.createBluePrint("PressureBody")
				.world(world)
				.shape(groundShape)
				.pointMasses([
					0,0,0,0,0,0,0,0,0,
			...
			var jellyCubeBluePrint = Jello.BodyFactory.createBluePrint("SpringBody")
				.world(world)
				.shape(ShapeBuilder.Shapes.Cube)
				.pointMasses(1)
				.rotate(0)
			...
			// Body
			jumpingCrate.setBody(Jello.BodyFactory.createBluePrint("SpringBody")
				.world(world)
				.shape(ShapeBuilder.Shapes.Cube)
				.pointMasses(1)
			...
			for(var i = 0; i < numberOfCubes; i++) {
				// materialized ground
				var body = Jello.BodyFactory.createBluePrint("Body")
					.world(world)
					.shape(shape)
			...
			var bodyBluePrintForCollisionType = Jello.BodyFactory.createBluePrint("SpringBody")
				.world(world)
				.shape(ShapeBuilder.Shapes.Cube)
				.pointMasses(1)
				.rotate(0)
			...
			var body = Jello.BodyFactory.createBluePrint("SpringBody")
				.world(world)
				.shape(shape)
			...
			var body2 = Jello.BodyFactory.createBluePrint("SpringBody")
				.world(world)
				.shape(shape)
				.pointMasses(1) // mass per point
			...
			var pressureBallBluePrint = Jello.BodyFactory.createBluePrint("PressureBody")
				.world(world)
				.shape(ShapeBuilder.Shapes.Ball)
				.pointMasses(1)
				.rotate(0)
			 ...
			 */
			var collectibleBluePrint = Jello.BodyFactory.createBluePrint("Body")
				.world(world)
			...
			var iBluePrint = Jello.BodyFactory.createBluePrint("SpringBody")
				.world(world)
			...
			var stick = Jello.BodyFactory.createBluePrint("SpringBody")
				.world(world)
				.shape(stickShape)
				.pointMasses(1) // mass per point
			...
			for (i = 1; i <= 5; i++) {
				var stick2 = Jello.BodyFactory.createBluePrint("SpringBody")
					.world(world)
					.shape(stickShape)
					.pointMasses(1) // mass per point
		...
		"setUpMenuLayer": function(layer, world) {
			...
			// Body
			guiElement.setBody(Jello.BodyFactory.createBluePrint("Body")
				.world(world)
				.shape(ShapeBuilder.Shapes.Cube)
				.pointMasses(0)
		...
		"setUpLiquidLayer": function(layer, world) {
			...
			// Sample loft
			var loft = Jello.BodyFactory.createBluePrint("Body")
				.world(world)
				.shape(groundShape)
				.pointMasses(Utils.Array.fill(0, groundShape.getVertices().length))
			...
			layer.setFluidSystem(new Jiquid.System(layer, world));
