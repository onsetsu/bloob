define([
	...
	var MapBuilder = {
		...
		"setUpLiquidLayer": function(layer, world) {
			...
			for (var i = -45; i < 0; i++)
		        for (var j = 5; j < 25; j++)
		        	fluidSystem.addParticle(new Floom.Particle(i, j, 0.1, 0, mat0));
		    
		    for (var i = 5; i < 50; i++)
		        for (var j = 5; j < 25; j++)
		        	fluidSystem.addParticle(new Floom.Particle(i, j, -0.1, 0, mat1));
		    
		    for (var i = -45; i < 0; i++)
		        for (var j = 30; j < 50; j++)
		        	fluidSystem.addParticle(new Floom.Particle(i, j, 0.1, 0, mat2));
		    
		    for (var i = 5; i < 50; i++)
		        for (var j = 30; j < 50; j++)
		        	fluidSystem.addParticle(new Floom.Particle(i, j, -0.1, 0, mat3));
