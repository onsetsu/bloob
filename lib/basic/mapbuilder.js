...
.defines(function(
	...
	var MapBuilder = {
		...
		"setUpTestMap": function(layer, world) {
			...
			blockEntity.setBody(block);
			layer.addEntity(blockEntity);
			
			blockEntity.setTexture(new Texture("sample.png")
				.from([new Jello.Vector2(20, 60), new Jello.Vector2(20, 20), new Jello.Vector2(60, 20)]).to([0,4,8])
				.from([new Jello.Vector2(60, 20), new Jello.Vector2(60, 60), new Jello.Vector2(20, 60)]).to([8,12,0])
			);
