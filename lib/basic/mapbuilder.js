			...
			(function() { 'use strict';
				class GamePadSystem extends System {
					constructor() {
						...
						env.input.bind(Input.GAMEPAD_KEY.BUTTON_7, 'LEFT_SHOULDER_THING');
						env.input.bind(Input.GAMEPAD_KEY.BUTTON_8, 'RIGHT_SHOULDER_THING');
					...
					update() {
						...
						if(Bloob.debug) {
							Bloob.debug.showNumber('State', i.state('A') ? 'YES' : 'NO');
							Bloob.debug.showNumber('Pressed', i.pressed('A') ? 'YES' : 'NO');
							Bloob.debug.showNumber('Released', i.released('A') ? 'YES' : 'NO');
						}
					}
				}
