mini.Module("editor/editorscene").requires("bloob/scenes/mapscene",
		"engine/scene", "basic/utils", "basic/mapbuilder", "engine/map/map",
		"assets/converter/tojson/maptojsonconverter", "editor/server").defines(
		function(MapScene, Scene, Utils, MapBuilder, Map, MapToJsonConverter,
				Server) {
