...
var Vector2 = require('num/num').Vector2,
    World = require('physics/jello').World;
...
wm.Weltmeister = Game.subclass({	
	...
	*/
	...
	loadNew: function() {
		...
		var emptyLayer = new Layer("default").setWorld(new World());
