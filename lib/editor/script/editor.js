...
wm.Weltmeister = Game.subclass({	
	...
	loadNew: function() {
		...
		var emptyLayer = new Layer().setWorld(new Jello.World());
	...
	load: function( dialog, name ) {
		...
		this.filePath = this.filePathToFileName(name);
