...
.defines(function(Utils){ "use strict";
...
wm.SelectFileDropdown = mini.Class.subclass({
	...
	initialize: function( elementId, filelistPHP, filetype ) {
		...
		this.boundHide = Utils.bind(this.hide, this);
		this.input.bind('focus', Utils.bind(this.show, this) );
		
		this.div = $('<div/>', {'class':'selectFileDialog'});
		this.input.after( this.div );
		this.div.bind('mousedown', Utils.bind(this.noHide, this) );
	...
	loadDir: function( dir ) {
		...
		var req = $.ajax({
			...
			dataType: 'json',
			async: false,
			success: Utils.bind(this.showFiles, this),
