define([
	...
	"geomath/path/line"
], function(Vector2, Jello, Segment, Curve, PathSmoother, PathFitter, PathFlattener, Line) {
	...
	ellipseSegments = [
		new Segment(new Vector2(-1, 0), new Vector2(0, kappa ), new Vector2(0, -kappa)),
		new Segment(new Vector2(0, -1), new Vector2(-kappa, 0), new Vector2(kappa, 0 )),
		new Segment(new Vector2(1, 0), new Vector2(0, -kappa), new Vector2(0, kappa )),
		new Segment(new Vector2(0, 1), new Vector2(kappa, 0 ), new Vector2(-kappa, 0))
	];
