...
.defines(function() {
	var Material = function() {
		...
		this.setColor(Material.getNextColor());
	...
	// debug colors
	Material.getNextColor = function() {
		return _.sample([
		        '#1f78b4',
		        '#b2df8a',
		        '#33a02c',
	...
	// debug properties
	Material.prototype.addDebugGui = function(folder) {
		folder.open();
	...
	Material.prototype.setParticleMass = function(stiffness) {
