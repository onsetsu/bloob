...
.defines(function(domReady, Menu, DebugPanel){ "use strict";
...
Jello.Body.shouldDebugDrawAngle = false;

var debugDrawTypeName = Jello.Body.prototype.debugDrawTypeName;
Jello.Body.prototype.debugDrawTypeName = function(debugDraw) {
	if(Jello.Body.shouldDebugDrawTypeName)
		debugDrawTypeName.apply(this, arguments);
};
Jello.Body.shouldDebugDrawTypeName = false;
	...
	Bloob.debug.addPanel({
		...
		options: [
				...
				},
				{
					name: 'Type & Name',
					object: Jello.Body,
					property: 'shouldDebugDrawTypeName'
				},
				{
					name: 'Target',
					object: Jello.Body,
