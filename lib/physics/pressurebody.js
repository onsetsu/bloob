var PressureBody = function(
	...
	var s = bodyDefinition.shape;
	var massperpoint = bodyDefinition.pointMasses;
	var pos = bodyDefinition.translate;
	var angleInRadians = bodyDefinition.rotate;
	var scale = bodyDefinition.scale;
	var kinematic = bodyDefinition.isKinematic;
	var edgeK = bodyDefinition.edgeSpringK;
	var edgeD = bodyDefinition.edgeSpringDamp;
	var shapeK = bodyDefinition.shapeSpringK;
	var shapeD = bodyDefinition.shapeSpringDamp;
	var gasPressure = bodyDefinition.gasPressure;
