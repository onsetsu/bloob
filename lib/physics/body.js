...
var bodyConstructorUnified = function(w, shape, pointMasses, position, angleInRadians, scale, kinematic) {
	var bodyDefinition = {
		"world": w,
		"shape": shape,
	...
	bodyConstructorBasics.apply(this, [bodyDefinition]);
	...
	if(arguments[2] instanceof Array) {
		...
		// massPerPoint
		// TODO: correct the && false-hack
		this.mIsStatic = (bodyDefinition.massPerPoint == 0.0) && false;
	}
	...
	bodyConstructorBasics3.apply(this, [bodyDefinition]);
};

var Body = function(w, shape, pointMasses, position, angleInRadians, scale, kinematic) {
	this._setDefaultValues();
	
	bodyConstructorUnified.apply(this, arguments);
};
...
Body.prototype._setDefaultValues = function() {
	...
	this.id = Body.nextBodyId.nextId();
};

Body.nextBodyId = new Bloob.UniqueIdGenerator("body");
