define([
	...
	var World = function() {
		...
		this.mWorldLimits = new AABB();
		this.mWorldSize = Vector2.Zero.copy();
		this.mWorldGridStep = Vector2.Zero.copy();
	...
	World.prototype.removeBody = function(body) {
		this.removeIfExisting(this.mBodies, body);
	};
	...
	World.prototype._goNarrowCheck = function(bI, bJ) {
		...
		if (bI.mBitMaskX.intersects(bJ.mBitMaskX) && 
			bI.mBitMaskY.intersects(bJ.mBitMaskY)) {
			// pass
		} else
			return;
