define([
	...
	var BodyDefinition = function(targetClass) {
		this.targetClass = Body;
	...
	var BodyBluePrint = function(targetClass) {
		this.store = new BodyDefinition(targetClass);
		if(targetClass === window.SpringBody) {
			console.log("SPRING");
			this.store.setUseSprings(true);
		}
		if(targetClass === window.PressureBody) {
