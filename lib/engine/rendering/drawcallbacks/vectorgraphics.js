	...
	return IDrawCallback.subclass({
		initialize: function() {
			...
			this.path = new GeoMath.Path()
				.add(new GeoMath.Path.Segment(new Vector2(-20,   20), undefined, new Vector2(10, 10)))
				.add(new GeoMath.Path.Segment(new Vector2(-20,    0), new Vector2(10,  -10), new Vector2(-5,  5)))
				.add(new GeoMath.Path.Segment(new Vector2(-50,    0), new Vector2(3,  10), new Vector2(-9,  -30)))
				.add(new GeoMath.Path.Segment(new Vector2(-50,   20), new Vector2(-1,  9), undefined))
				.remove(1)
			...
			this.path2 = new GeoMath.Path()
				.add(new GeoMath.Path.Segment(new Vector2(-90, 0)))
			...
			this.insertPath = new GeoMath.Path()
				.add(new GeoMath.Path.Segment(new Vector2(10, 25)))
				.add(new GeoMath.Path.Segment(new Vector2(30, 25)))
				.insert(new GeoMath.Path.Segment(new Vector2(20, 10)), 1);
			this.arcPath = new GeoMath.Path()
				.add(new GeoMath.Path.Segment(new Vector2(0, 0)))
			...
			this.smoothedPath = new GeoMath.Path()
				.add(new GeoMath.Path.Segment(new Vector2(-60, 0)))
				.add(new GeoMath.Path.Segment(new Vector2(-50, 10)))
				.add(new GeoMath.Path.Segment(new Vector2(-40, 0)))
				.close(true)
				.smooth();
			this.simplifiedPath = new GeoMath.Path()
				.add(new GeoMath.Path.Segment(new Vector2(-30, 0)))
				.add(new GeoMath.Path.Segment(new Vector2(-29, 0)))
				.add(new GeoMath.Path.Segment(new Vector2(-28, 1)))
				.add(new GeoMath.Path.Segment(new Vector2(-27, 3)))
				.add(new GeoMath.Path.Segment(new Vector2(-26, 4)))
				.add(new GeoMath.Path.Segment(new Vector2(-25, 4.5)))
				.add(new GeoMath.Path.Segment(new Vector2(-24, 4)))
				.add(new GeoMath.Path.Segment(new Vector2(-23, 3)))
				.add(new GeoMath.Path.Segment(new Vector2(-22, 1)))
				.add(new GeoMath.Path.Segment(new Vector2(-21, 0)))
				.add(new GeoMath.Path.Segment(new Vector2(-20, 0)))
				.simplify(2.5);
			this.flattenedPath = new GeoMath.Path()
				.add(new GeoMath.Path.Segment(new Vector2(-60, -20)))
		...
		draw: function(entity, renderer) {
			...
			this.wavePath.add(new GeoMath.Path.Segment(new Vector2(this.wave.x, waveValue))).draw();
			if(this.wavePath.segments.length > 100) this.wavePath.remove(0);
			var waveValue = this.wave2.update(env.time.timePassed);
			this.wavePath2.add(new GeoMath.Path.Segment(new Vector2(this.wave2.x, waveValue))).draw();
