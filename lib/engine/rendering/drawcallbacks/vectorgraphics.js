define([
	...
	return IDrawCallback.subclass({
		initialize: function() {
			...
			this.path = new Path([
				new Path.Segment(new Jello.Vector2(-20,  20), new Jello.Vector2(10,  0), new Jello.Vector2(0, -20)),
				new Path.Segment(new Jello.Vector2(-30,  15), new Jello.Vector2(0,  -10), new Jello.Vector2(-5,  10)),
				new Path.Segment(new Jello.Vector2(-40,   0), new Jello.Vector2(3,  10)),
				new Path.Segment(new Jello.Vector2(-50,  -5), undefined, new Jello.Vector2(-1,  9))
			]).setIsClosed(true);
		},
