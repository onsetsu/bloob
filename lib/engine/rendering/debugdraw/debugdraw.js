...
.defines(function(Renderer) {
	var DebugDraw = Renderer.subclass({
		...
		drawDot: function(vec, size) {
			return this.drawDotNEW(vec, size);
		...
		drawPlus: function(point, size) {
			return this.drawPlusNEW(point, size);
		...
		drawPlusNEW: function(point, size) {
			size = size || 3;
		...
		drawTextWorld: function(text, worldPoint) {
			return this.drawTextWorldNEW(text, worldPoint);
		...
		drawTextWorldNEW: function(text, worldPoint) {
			this.context.save();
