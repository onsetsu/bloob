define([
	...
	var main = function(game, canvasId, canvasWidth, canvasHeight) {
		domReady(function() {
			env = {};
			...
			env.canvas = new Canvas(canvasId, canvasHeight, canvasWidth);
			...
			env.camera = new Camera(env.canvas.extent, desiredExtent);
