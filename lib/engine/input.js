...
.defines(function() {
		...
		Scarlet.Input = function(domElementId) {
			var that = this;
		...
		var Input = Scarlet.Input;
		Input.prototype.onRightClick = function(callback) {
		...
		Input.prototype.initAccelerometer = function() {
		...
		Input.prototype.contextmenu = function(event) {
		...
		Input.prototype.devicemotion = function(event) {
		...
		Input.prototype.bindTouch = function(selector, action) {
		...
		Input.prototype.touchStart = function(event, action) {
			this.actions[action] = true;
			this.presses[action] = true;
		...
		Input.prototype.touchEnd = function(event, action) {
			this.delayedKeyup[action] = true;
			event.stopPropagation();
			event.preventDefault();
			return false;
