define(function() { 'use strict';
	...
	class Loop {
		...
		remove(keyForRemoval) {
			var canRemove = this.callbacks.has(keyForRemoval);

			if(canRemove) {
                // TODO: remove debug output
                console.log('REMOOOOOOOOOOOOOOOOOOOOVVEEEEEEEEEEEEEEEE?', keyForRemoval);
                this.callbacks.delete(keyForRemoval);
			} else {
                console.log('NOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO?', keyForRemoval);
            }
