define([
...
], function(require, Layer, Viewport) {
    var AffineTransformation = require("num/matrix3x3");
	...
	var Camera = mini.Class.subclass({
		...
		updateTransform: function() {
            ...
            transform.scaleSelf(new Vector2(1, -1));
            transform.scaleSelf(layer.scale);
            transform.scaleSelf(Vector2.One.divVector(this.viewport.extent));
