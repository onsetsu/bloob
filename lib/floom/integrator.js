define(["physics/jello"], function(Jello) {
	...
	Integrator.prototype.integrate = function(particle, fn) {
		fn.call(undefined, particle, particle.node[0], particle.s[0], particle.sx[0], particle.sy[0]);
		fn.call(undefined, particle, particle.node[1], particle.s[1], particle.sx[1], particle.sy[1]);
		fn.call(undefined, particle, particle.node[2], particle.s[2], particle.sx[2], particle.sy[2]);
		fn.call(undefined, particle, particle.node[3], particle.s[3], particle.sx[3], particle.sy[3]);
		fn.call(undefined, particle, particle.node[4], particle.s[4], particle.sx[4], particle.sy[4]);
		fn.call(undefined, particle, particle.node[5], particle.s[5], particle.sx[5], particle.sy[5]);
		fn.call(undefined, particle, particle.node[6], particle.s[6], particle.sx[6], particle.sy[6]);
		fn.call(undefined, particle, particle.node[7], particle.s[7], particle.sx[7], particle.sy[7]);
		fn.call(undefined, particle, particle.node[8], particle.s[8], particle.sx[8], particle.sy[8]);
	};
