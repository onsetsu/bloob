	...
	Tool.prototype.spawn = function() {
		for(var i = 0; i < 10; i++) {
			...
			this.system.particles.push(
				new Particle(
					x + this.interactionCurrentPoint.x,
					y + this.interactionCurrentPoint.y,
					0, //this.interactionCurrentPoint.x - this.interactionLastPoint.x,
					0, //this.interactionCurrentPoint.y - this.interactionLastPoint.y,
