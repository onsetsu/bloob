define(["physics/jello", "floom/node"], function(Jello, Node) {
	...
	var Particle = function(x, y, u, v, material){
	    ...
	    this.node0 = defaultNode;
	    this.node1 = defaultNode;
	    this.node2 = defaultNode;
	    this.node3 = defaultNode;
	    this.node4 = defaultNode;
	    this.node5 = defaultNode;
	    this.node6 = defaultNode;
	    this.node7 = defaultNode;
	    this.node8 = defaultNode;
	};
