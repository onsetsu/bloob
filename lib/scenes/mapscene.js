...
Bloob.MapScene.prototype.initMouseInteraction = function() {
	...
	interactionTechniques[tecNothing.store.name] = tecNothing;
	interactionTechniques[tecDragBody.store.name] = tecDragBody;
	interactionTechniques[tecSpawnCube.store.name] = tecSpawnCube;
	interactionTechniques[tecSelectBody.store.name] = tecSelectBody;
	interactionTechniques[tecPauseGame.store.name] = tecPauseGame;
	interactionTechniques[tecCallCallback.store.name] = tecCallCallback;
