Bloob.MapScene = function(game, loop) {
	...
	this.mouse = new Bloob.Mouse(this.world, this.camera, this)
		.onLeftClick(Bloob.Mouse.InteractionTechniques["DRAG_BODY"], "DRAG_BODY")
		.onRightClick(Bloob.Mouse.InteractionTechniques["SPAWN_CUBE"], "SPAWN_CUBE");
	this.mouse.callback = function() { Scarlet.log("hallo"); };
};
