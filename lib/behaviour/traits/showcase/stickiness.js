define([
	...
	"basic/utils",
	"jello"
], function(require, num, Trait, ITrait, ShapeBuilder, Utils, Jello) {
    var Jello = require('jello'),
        BodyFactory = Jello.BodyFactory,
        DistanceJoint = Jello.DistanceJoint;
	...
	var stickiness = ITrait.subclass({
		...
		createStickyJoints: function() {
			...
			for (var i = 0; i < body.getBoundaryCount(); i++)
			{
				...
				var temp = jointInfo.temp = BodyFactory.createBluePrint()
					.world(world)
