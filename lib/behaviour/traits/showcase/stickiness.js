mini.Module(
	"behaviour/traits/showcase/stickyness"
)
.requires(
	"behaviour/trait",
...
.defines(function (Trait, ITrait, ShapeBuilder, Utils) {
	
	var stickyness = ITrait.subclass({
		...
		makeSticky: function() {
			...
			this.pointMassIsConnected = Utils.Array.fill(false, this.body.mPointCount);
	...
	Trait.Repository.add("showcase/stickyness", stickyness);
});
